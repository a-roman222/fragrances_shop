...
ActiveRecord::Schema[7.2].define(version: 2024_11_10_062545) do
  ...
  create_table "order_items", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["fragrance_id"], name: "index_order_items_on_fragrance_id"
  ...
  add_foreign_key "order_items", "fragrances"
